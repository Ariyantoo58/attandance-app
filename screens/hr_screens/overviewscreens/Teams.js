...
const Teams = ({ navigation, route }) => {
    ...
    // Removed handleSubmitTeam and modal helpers as management is now on a dedicated screen
            ...
            <FlatList
                ...
                ListEmptyComponent={
                    <View style={styles.emptyContainer}>
                        ...
                        {isManager && (
                           <TouchableOpacity style={styles.emptyCreateBtn} onPress={() => navigation.navigate('TeamEdit')}>
